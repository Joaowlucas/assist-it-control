...
export const EditFlowDialog = ({ open, onOpenChange, flow }: EditFlowDialogProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await updateFlow(flow.id, formData);
      onOpenChange(false);
    } catch (error) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Modifique as configurações do fluxo de conversa
          </DialogDescription>
        </DialogHeader>
