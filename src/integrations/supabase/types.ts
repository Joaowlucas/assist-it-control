  ...
  public: {
    Tables: {
      ...
      kanban_board_participants: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_kanban_board_participants_added_by"
            columns: ["added_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "fk_kanban_board_participants_user_id"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      kanban_tasks: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_kanban_tasks_assigned_to"
            columns: ["assigned_to"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "fk_kanban_tasks_created_by"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
